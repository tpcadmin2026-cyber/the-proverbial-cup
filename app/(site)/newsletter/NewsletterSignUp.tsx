        ...
        <div className="bg-white border border-[#c8c4a8] rounded-lg shadow-md overflow-hidden">
          ...
          {status === 'success' ? (
            ...
            <form onSubmit={handleSubmit} className="px-8 py-8 space-y-5">
              ...
              >
                {status === 'submitting' ? 'Enrolling…' : 'Enrol in the Correspondence List'}
              </button>

              <p className="text-xs text-center text-[#C4AB77]">
                You may unsubscribe at any time. We shall never sell your address.
              </p>
            </form>
          )}
        </div>
